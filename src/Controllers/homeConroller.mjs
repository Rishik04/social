...
export const postdata= async (req,res)=>{
    try{
        ...
        return res.send({status: 200, allpost: postnew, title: "Shortpost | Home"});
        }
        else{
